...
\input{figs/network.tikz}
\vspace*{-\baselineskip}
\vspace*{-\baselineskip}
\begin{figure}[H]
  \centering
  \caption{
    figure showing the abstract structure of a neural network, $(x, y)$ pair are
    some input and prediction of the network, values $t_1,...,t_L$ here are
    \textbf{activations} of layers $1,...,L$
  }
  \label{fig:network}
\end{figure}
