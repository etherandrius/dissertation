...
\begin{itemize}
  \item{
      Tishby produced a paper \cite{ti} claiming to understand the basic principles of how
      DNNs work. 
    }
  \item{
      He decided to examine neural networks trough the information domain,
